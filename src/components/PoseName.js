...
const PoseName = (props) => {
    ...
    return(
        <div className="flex justify-start gap-1">
            ...
            {editMode && <input type="text" className="poseName-entry" defaultValue={poseName} onChange={updateInputField} size={inputWidth<3 ? 3:inputWidth}/>}
            <svg xmlns="http://www.w3.org/2000/svg" className="edit-button h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
