...
const EditorCanvas = (props) => {
  ...
  const draw = useCallback(() => {
    ...
    if (poseData.poseLandmarks) {
      ...
      drawBiceps(poseData, context, armWidth, width, height, false);
      drawForearms(poseData, context, armWidth, width, height, false);
      drawThighs(poseData, context, armWidth, width, height, false);
